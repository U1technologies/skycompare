...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SkyCompare — Compare Hotel & Flight Prices from Top Travel Brands" },
      ...
      { name: "twitter:title", content: "SkyCompare — Compare Hotel & Flight Prices from Top Travel Brands" },
